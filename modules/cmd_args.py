...
parser.add_argument("--install-only", action='store_true', help='initialize environment and install dependencies without running the API or webui", default=False)
